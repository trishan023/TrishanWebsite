...
export const timeline = [
  ...
  },
  {
    ...
    role: "Graduate → Senior Consultant",
    period: "Mar 2018 – Jun 2023",
    location: "Sydney, AU",
    type: "Consulting",
    highlights: [
      "Led client-facing data analytics engagements across financial services, energy, and public sector, combining technical expertise with consulting acumen to deliver measurable business outcomes.",
      "Acted as primary liaison with senior client stakeholders, leading scope discussions, collaborative problem-solving, and outcome delivery across engagements.",
      "Delivered finance reconciliation, audit analytics and projects in banking, identifying material risks, fraud indicators, and strengthening regulatory compliance.",
      "Partnered with Deloitte Partners on go-to-market strategy for AI-driven analytics solutions, positioning Deloitte as a leader in AI-enabled regulatory compliance.",
  ...
  },
  {
    ...
    type: "Academic",
    highlights: [
      "Taught undergraduate mechanical engineering courses including Engineering Design, AutoCAD, and Heat Transfer at the University of Mumbai.",
      "Taught GRE, GMAT, and SAT mathematics curriculum at EDWISE International.",
    ...
    tags: ["Teaching", "Engineering Design", "AutoCAD", "Heat Transfer", "Mathematics"],
